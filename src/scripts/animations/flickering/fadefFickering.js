...
const $title = document.querySelector('.js-texts-animation-1-flickering')
...
function fadefFickering($texts,  optionsParam) {
    ...
    tl.to($SplitText, {
        ...
        `options.stagger`. */
        ease:RoughEase.ease.config({points:10, strength: 20, clamp: true, taper: 'in', randomize: false}),
