...
const $title = document.querySelector('.js-texts-animation-2-rotateOvershoot')

/* This is creating a timeline for each word in the text. */
positionRotateOvershoot($title, {
    inDirection: 'bottom',
    outDirection: 'bottom',
    duration: 22,
    inDuration: 10,
...
function positionRotateOvershoot($texts, optionsParam) {
    if (!$texts) return
    ...
    tl.to($splitText, {
        ...
        .to($splitText, {
            ...
            stagger: {
                from: 'end',
                /** start center end center end center end**/
                each: options.outStagger()
            }
